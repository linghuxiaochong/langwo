...
router.get('/', async function (req, res) {
  ...
  let searchObj = {};
  let data = await client.get('/hot', { page, rows, submitType: "findJoin", ref: "movies" });
...
//   if (Array.isArray(body)) {
//     for (let i = 0; i < body.length; i++) {
//       await client.delete('/hot/' + body[i]);
//     }
//   } else {
//     await client.delete('/hot/' + body);
//   }
//   res.send("suc");
// });
